...
<x-landowner-shell title="My Parcel Map" active="parcel-map">
    @push('styles')
        ...
        <style>
            ...
            .lo-map-tools{margin-top:13px;display:grid;gap:8px}.lo-map-button{width:100%;min-height:39px;border:1px solid #d7ded9;border-radius:9px;background:#fff;color:#344054;display:inline-flex;align-items:center;justify-content:center;gap:8px;padding:8px 11px;font-size:11px;font-weight:900;text-decoration:none;cursor:pointer}.lo-map-button.primary{border-color:var(--lo-green-800);background:var(--lo-green-800);color:#fff}
